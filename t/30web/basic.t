...
# login
$t = Test::Mojo->new(app => 'CollabIRCate::Web');
$t->get_ok('/user/login')->status_is(200)->content_type_is('text/html')
  ->content_like(qr/username/i)
  ->content_like(qr/password/i);

# logout
$t = Test::Mojo->new(app => 'CollabIRCate::Web');
$t->get_ok('/user/logout')->status_is(200)->content_type_is('text/html')
